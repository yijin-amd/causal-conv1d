...
HIP_VISIBLE_DEVICES=7 rocprofv3 --hip-runtime-trace --kernel-trace --output-format csv pftrace -d trace_casual_conv1d -o matrix_casual_conv1d_out_m_1024_n_32_k_128 --stats -- ./casual_conv1d_opus.exe
